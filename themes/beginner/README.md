...
### GitHub リポジトリ から Beginner テーマを使用する手順

1. GitHub から最新版のソースコードをダウンロードする。
2. a-blog cms を設置した環境の /themes 直下に、ダウンロードファイル内にある /themes/beginner を設置する。
3. 「/setup（CMSを既インストールした場合はリネイムされてます）/bin/」内に、　GitHub からダウンロードしたファイルに含まれている /_bin/beginner を設置する。<br>※ すでに beginner フォルダがある場合は、上書きする。
